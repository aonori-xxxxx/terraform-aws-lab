...
#=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
az_input = {
  az_a = "ap-northeast-3a"
  az_c = "ap-northeast-3c"
}
...
#AZ-a
subnet_input = {
  subnet_public_elb_a  = "10.24.0.0/28"
  subnet_public_nat_a  = "10.24.0.16/28"
  subnet_private_elb_a = "10.24.0.32/28"
  subnet_private_rds_a = "10.24.0.48/28"
  subnet_private_tgw_a = "10.24.0.64/28"
  subnet_private_srv_a = "10.24.0.96/27"

  #AZ-c
  subnet_public_elb_c  = "10.24.0.128/28"
  subnet_public_nat_c  = "10.24.0.144/28"
  subnet_private_elb_c = "10.24.0.160/28"
  subnet_private_rds_c = "10.24.0.176/28"
  subnet_private_tgw_c = "10.24.0.208/28"
  subnet_private_srv_c = "10.24.0.224/27"
}
