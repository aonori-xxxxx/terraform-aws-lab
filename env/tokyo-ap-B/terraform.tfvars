...
#AZ-a
subnet_input = {
  subnet_public_elb_a  = "10.20.1.0/28"
  subnet_public_nat_a  = "10.20.1.16/28"
  subnet_private_elb_a = "10.20.1.32/28"
  subnet_private_rds_a = "10.20.1.48/28"
  subnet_private_tgw_a = "10.20.1.64/28"
  subnet_private_srv_a = "10.20.1.96/27"

  #AZ-c
  subnet_public_elb_c  = "10.20.1.128/28"
  subnet_public_nat_c  = "10.20.1.144/28"
  subnet_private_elb_c = "10.20.1.160/28"
  subnet_private_rds_c = "10.20.1.176/28"
  subnet_private_tgw_c = "10.20.1.208/28"
  subnet_private_srv_c = "10.20.1.224/27"
}
