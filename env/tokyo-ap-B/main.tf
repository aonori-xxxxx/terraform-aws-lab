...
module "elb" {
  ...
  s3_bucket_id      = data.terraform_remote_state.common.outputs.s3_bucket_id
  ssl_output        = data.terraform_remote_state.common.outputs.ssl_output
}
...
module "cloud_watch" {
  ...
  sns_error_arn               = data.terraform_remote_state.common.outputs.sns_error_arn
  sns_emergency_arn           = data.terraform_remote_state.common.outputs.sns_emergency_arn
}
